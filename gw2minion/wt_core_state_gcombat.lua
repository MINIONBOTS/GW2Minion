...
function c_gcombat_over:evaluate()
	...
	if ( wt_core_state_gcombat.CurrentTarget == nil or wt_core_state_gcombat.CurrentTarget == 0 ) then
		...
		or (T ~= nil and wt_global_information.TargetIgnorelist ~= nil and wt_global_information.TargetIgnorelist[T.contentID2] ~= nil and wt_global_information.TargetIgnorelist[T.contentID2] < T.health.percent)
